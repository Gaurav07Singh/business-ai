...
import { Upload, Wand2, ArrowLeft, Loader2, Download, Image as ImageIcon } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-purple-50 to-blue-50 flex items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-[500px] h-[500px] bg-gradient-to-br from-blue-400/20 to-cyan-400/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            ...
            >
              ...
              <button
                ...
                disabled={!uploadedImage || !prompt || isAnalyzing || isGenerating}
                  ...
                  >
                    ...
                    {analysisResult && (
                      <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-4 border border-purple-200">
                        <p className="text-sm font-semibold text-gray-700 mb-2">Image Analysis:</p>
                        <p className="text-sm text-gray-600 leading-relaxed">{analysisResult}</p>
                      </div>
                    )}
                    ...
                    {isAnalyzing || isGenerating ? (
                      <div className="space-y-4">
                        ...
                        <p className="text-lg font-semibold text-gray-700">
                          {isAnalyzing ? 'Analyzing your image...' : 'Generating your image...'}
                        </p>
                      ...
                      <div className="space-y-4 w-full">
                        ...
                        <div className="bg-red-50 border border-red-200 rounded-xl p-4">
                          <p className="text-sm font-semibold text-red-700 mb-2">Analysis Error:</p>
                          <p className="text-sm text-red-600 leading-relaxed">{analysisResult}</p>
                        </div>
                        <button
                          onClick={handleReset}
